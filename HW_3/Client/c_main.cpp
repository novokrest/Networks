...
static const int ARGUMENTS_COUNT = 7;
static const char* HELP_MESSAGE = "client [-n <name>] [-sip <server_ip>] [-sport <server_port>]";

static int parse_arguments(char* argv[], string& name, string& server_ip, string& server_port)
{
...
int main(int argc, char* argv[])
{
    ...
    parse_arguments(argv, name, server_ip, server_port);
